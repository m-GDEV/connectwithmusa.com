...
export default function Footer() {
    ...
    return (
        <footer className="flex flex-col sm:flex-row justify-center items-center bg-g-dark bottom-0 left-0 text-center w-full text-white text-sm sm:text-base pb-4">
            ...
            <p>
            <a href="https://github.com/m-GDEV/connectwithmusa.com" target="_blank"><img alt="github logo" src="https://img.shields.io/badge/Source%20Code-white?style=for-the-badge&logo=github&logoColor=black"

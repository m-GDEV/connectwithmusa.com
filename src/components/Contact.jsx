...
export default function Contact() {
  const val = `New submission from Contact page! - ${new Date(
    Date.now()
  ).toDateString()}`;
      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40 ">
        <div className="flex flex-col w-full mb-16">
          <div className={classchange}>
            <ChatAlt2Icon className="mx-auto inline-block w-10 mb-4 text-t-darkyellow" />
          </div>
        ...
        <form
          className="font-dm-sans text-t-darkyellow outline-none drop-shadow-2xl"
          id="contact"
          action="https://formsubmit.co/musaa.ahmed7@gmail.com"
          method="POST"
        >
          {/* https://formsubmit.co */}
        ...
        bg-b-darkishpurple text-xl placeholder:text-[#AA9106] outline-none"
          ...
          <button
            type="submit"
            className="inline-flex mt-3 text-xl bg-b-darkishpurple px-6 py-2 border-[3px] border-br-lightpurple
